...
1. [Описание исходных данных](#описание-исходных-данных)

   1.1. [Алгоритм прямого обхода дерева](#алгоритм-прямого-обхода-дерева)

   1.2. [Структура данных стартового датасета](#структура-данных-стартового-датасета)

2. [Преобразование датасета «Python ASTs»](#преобразование-датасета-python-asts)

   2.1. [Подготовка данных к фильтрации](#подготовка-данных-к-фильтрации)

   2.2. [Формирование словаря функций](#формирование-словаря-функций)

   2.3. [Формирование словаря значений](#формирование-словаря-значений)

   2.4. [Фильтрация данных](#фильтрация-данных)
